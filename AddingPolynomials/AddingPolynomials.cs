...
class AddingPolynomials
{
    ...
    static int[] AddPolynomials(int[] first, int[] second, int length)
    {
    ...
    static void Main()
    {
        ...
        Console.WriteLine(ConvertArrayToString(AddPolynomials(firstPolynomial, secondPolynomial, number)));
